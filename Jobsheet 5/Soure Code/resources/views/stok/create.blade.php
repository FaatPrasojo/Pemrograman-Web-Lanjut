...
<div class="card card-outline card-primary">
    ...
    <div class="card-body">
        <form method="POST" action="{{ url('stok') }}" class="form-horizontal">
            ...
            <div class="form-group row">
                <label class="col-2 control-label col-form-label">User Pencatat</label>
                <div class="col-10">
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="datetime-local" class="form-control" id="stok_tanggal" name="stok_tanggal"
                        value="{{ old('stok_tanggal', now()->format('Y-m-d\TH:i')) }}" required>
                    @error('stok_tanggal')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-10">
                    <input type="number" class="form-control" id="stok_jumlah" name="stok_jumlah"
                        value="{{ old('stok_jumlah') }}" placeholder="Masukan Jumlah Stok" min="1" required>
                    @error('stok_jumlah')
                        <small class="form-text text-danger">{{ $message }}</small>
                    @enderror
                </div>
